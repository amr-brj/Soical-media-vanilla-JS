let imgUser = JSON.parse(localStorage.getItem('user')).profile_image
...
async function getUser() {
    let res = await axios.get("https://tarmeezacademy.com/api/v1/users/" + sessionStorage.getItem("id"))
    let data = res.data.data;
    let username = data.username
    let profileImage = data.profile_image
    if (profileImage == "[object Object]")
        profileImage = "https://cdn-icons-png.flaticon.com/512/149/149071.png";
    document.querySelector(".profile-user-img").innerHTML =
        `
        <img src="${profileImage}" alt="profile image" id="profile-page-image">
        <h2 class="user-name">${username}</h2>
    `
}
async function getPosts() {
    apiUrl = "https://tarmeezacademy.com/api/v1/users/" + sessionStorage.getItem("id") + "/posts"
    ...
    for (data of posts) {
        ...
        document.getElementById("posts-profile").innerHTML += `
                    <div class="card mb-2">
                                <!-- Post Header  -->
